...
const GraphResponse = React.memo(({ response }) => {
    ...
    return (
        <div style={{ height: !graphData ? "fit-content" : "500px", width: "calc(100vw - 200px)", border: "1px solid #000000", borderRadius: "4px", padding: "16px", display: "flex", flexDirection: "column", gap: "20px" }}>
